 ...
 */
#ifdef FLASH_SWAP
#define AMD_MANUFACT	0x80008000	/* AMD	   manuf. ID in D23..D16, D7..D0 */
#define SST_MANUFACT	0xFD00FD00
#define MX_MANUFACT	0x43004300      /*Add by kaiker,MXIC */
#define INTEL_MANUFACT	0x91009100	/* INTEL   manuf. ID in D23..D16, D7..D0 */
#define AMD_MANUFACT_EON 0x42004200	/*Add by kaiker */


#define AMD_ID_LV640U	0xEB44EB44	/* 29LV640U ID (64 M, uniform sectors)	*/
#define INTEL_ID_28F800C3B  0x83118311	/*  8M = 512K x 16 bottom boot sector	*/
#define INTEL_ID_28F800B3B  0xC911C911	/*  8M = 512K x 16 bottom boot sector	*/
#define INTEL_ID_28F160C3B  0xC311C311	/*  16M = 1M x 16 bottom boot sector	*/
#define INTEL_ID_28F160B3B  0x89118911	/*  16M = 1M x 16 bottom boot sector	*/
#define INTEL_ID_28F320C3B  0xA311A311	/*  32M = 2M x 16 bottom boot sector	*/
#define INTEL_ID_28F320B3B  0xE911E911	/*  32M = 2M x 16 bottom boot sector	*/
#define INTEL_ID_28F640C3B  0xB311B311	/*  64M = 4M x 16 bottom boot sector	*/
#define INTEL_ID_28F640B3B  0x99119911	/*  64M = 4M x 16 bottom boot sector	*/
#define AMD_ID_LV320B	0x00009F44	/* 29LV320B ID (32 M, bottom boot sect) */
#define MX_ID_LV320BT   0x00001544    /* 4 M x 16 T/B add by kaiker  */
#define MX_ID_29LV640DB 0x0000D344	/* 29LV640DBTC (64M, bottom boot sect) */
#define MX_ID_29LV128DB 0x00005E44	/* 29LV128DBTC (128M, bottom boot sect) */
#define EN_ID_29LV640H   0x00001444 /* 8 M x 16 T/B add by kaiker  */
...
#define MX_ID_29LV160DB 0x00002249      /* 29LV160DBTI (16M, bootom boot sect), wanles 2008-08-22 */
...
#ifdef FLASH_SWAP
#define FLASH_MXLV320BT 0x1544     /* Mx 29LV4320B/T  (4M x 16) */
#else
