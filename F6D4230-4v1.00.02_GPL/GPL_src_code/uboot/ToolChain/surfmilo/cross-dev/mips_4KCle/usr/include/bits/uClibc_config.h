...
#define __KERNEL_SOURCE__ "$(KERNEL_SRC)"
 ...
 */
#define __SHARED_LIB_LOADER_PREFIX__ "$(KERNEL_SRC)/../../uclibc/shared"
#define __RUNTIME_PREFIX__ "$(KERNEL_SRC)/../../rootfs/rootdir"
#define __DEVEL_PREFIX__ "$(KERNEL_SRC)/../../uclibc/usr"
